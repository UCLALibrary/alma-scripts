...
def get_expiry_date() -> str:
    """Returns the expiry date, calculated as about 13 months from today.
    No need for day-of-month precision here.
...
def get_purge_date() -> str:
    """Returns the purge date, calculated as 1 year after the expiry date.
    No need for day-of-month precision here.
    Format as 'YYYY-MM-DD'.
    """
    expiry_date = datetime.strptime(get_expiry_date(), "%Y-%m-%d")
    purge_date = expiry_date + timedelta(days=365)
